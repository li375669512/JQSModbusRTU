...
#define RS485_TX_ENABLE()                HAL_GPIO_WritePin(RS485_CTR_GPIO_Port, RS485_CTR_Pin, GPIO_PIN_SET)//bsp_gpio_write(RS485_TR_CTR, SET)
#define RS485_TX_DISABLE()               HAL_GPIO_WritePin(RS485_CTR_GPIO_Port, RS485_CTR_Pin, GPIO_PIN_RESET)//bsp_gpio_write(RS485_TR_CTR, RESET)
#define RS485_TX_ENABLE_IO()             (HAL_GPIO_ReadPin(RS485_CTR_GPIO_Port, RS485_CTR_Pin))// bsp_gpio_read(RS485_TR_CTR) && 
